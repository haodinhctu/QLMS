<template>
  <div class="page row">
    <div class="col-md-10">
      <InputSearch v-model="searchText" class="mb-3" />
      <h4>
        Sách
    ...
    <div class="mt-3 col-md-6">
      ...
      />
      <p v-else class="text-muted fst-italic">Không có dữ liệu.</p>
    ...
    <div class="mt-3 col-md-6">
      <div v-if="activeBook">
        ...
        <button
          v-else
          class="mt-2 badge bg-info text-dark btn btn-sm btn-primary"
          @click="borrowBook"
        >
